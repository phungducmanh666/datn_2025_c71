...
public class StaffSQL {
  // #region staff
  public static String CREATE_STAFF_SEQUENCE() {
    return """
        IF NOT EXISTS (SELECT * FROM sys.sequences WHERE name = 'StaffCodeSeq')
        BEGIN
          CREATE SEQUENCE StaffCodeSeq
          START WITH 1
          INCREMENT BY 1;
        END
        """;
  ...
  public static String CREATE_STAFF(
      String firstName,
      String lastName,
    ...
    // params.put("code", code); // No longer needed
    ...
    return String.format(
        """
            INSERT
            INTO %s (code, first_name, last_name, gender, birth_date, phone_number, email)
            OUTPUT inserted.uuid, inserted.code, inserted.first_name, inserted.last_name, inserted.birth_date, inserted.gender, inserted.phone_number, inserted.email
            VALUES (CONCAT('NV', FORMAT(NEXT VALUE FOR StaffCodeSeq, '00000')), :first_name, :last_name, :gender, :birth_date, :phone_number, :email)
            """,
        DBTableName.STAFF);
  }

  public static String SELECT_STAFF_BY_UUID(UUID uuid, Map<String, Object> params) {
  ...
  public static String SELECT_STAFF_BY_CODE(String code, Map<String, Object> params) {
  ...
  public static String UPDATE_GENDER(UUID uuid, Boolean gender, Map<String, Object> params) {
    params.put("uuid", uuid);
  ...
  public static String CHECK_CODE_EXISTS(String code, Map<String, Object> params) {
    params.put("code", code);
    return String.format("""
  ...
  public static String SELECT_BY_FILTER(
      ...
      String search,
      Map<String, Object> params) {
    StringBuilder sql = new StringBuilder("SELECT * FROM ").append(DBTableName.STAFF);
  ...
  public static String COUNT_BY_FILTER(String search, Map<String, Object> params) {
    StringBuilder sql = new StringBuilder("SELECT COUNT(*) AS cnt FROM ").append(DBTableName.STAFF);
  ...
  // #region account
  public static String CREATE_ACCOUNT(UUID staffUUID, String code, Map<String, Object> params) {
    params.put("username", code);
    params.put("password", PasswordEncoder.encode(code));
  ...
  // #region statistics
  public static String COUNT_ALL_STAFF() {
    return String.format("""
        SELECT COUNT(*) AS cnt
        FROM %s
        """, DBTableName.STAFF);
