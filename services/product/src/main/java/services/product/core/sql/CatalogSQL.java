...
public class CatalogSQL {
    ...
    public static String SELECT_BY_FILTER(Integer page, Integer size, String sort, String search,
        ...
        StringBuilder sql = new StringBuilder("SELECT * FROM ").append(DBTableName.CATALOG);
    ...
    public static String COUNT_BY_FILTER(String search, Map<String, Object> params) {
        StringBuilder sql = new StringBuilder("SELECT COUNT(*) AS cnt FROM ").append(DBTableName.CATALOG);
