...
import { PurchaseOrderData, SupplierData } from "@data/warehouseData";
  ...
  const tableColumns = useMemo<TableProps<BrandData>["columns"]>(
    () => [
      ...
      // },
      {
        ...
        dataIndex: "supplier",
        key: "supplier",
        render: (supplier: SupplierData) => <>{supplier.name}</>,
      },
      {
        title: "Nhân viên",
        key: "staff",
        render: (r: PurchaseOrderData) =>
          ConvertUtil.getPurchaseOrderStatusLabel(
            r.receipt == null ? false : true
          ),
      },
      {
        title: "Nhân viên",
      ...
      },
      {
        ...
        dataIndex: "createdAt",
        key: "createdAt",
        render: (createdAt) => <>{ConvertUtil.convertVietNamDate(createdAt)}</>,
      },
      {
        title: "Thao tác",
        key: "action",
