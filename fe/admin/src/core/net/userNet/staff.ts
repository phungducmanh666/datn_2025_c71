...
import { AccountData, StaffData } from "@data/userData";
...
export class StaffAPI {
  ...
  static async getAccount(code: string): Promise<AccountData> {
    try {
      const res = await fetchWithAuth(`${this.prefix}/${code}/account`, {
        method: "GET",
      });
