...
import { useUpdateBrandPhoto } from "@hook/productHook/brandHook";
...
interface FMBrandUpdatePhotoProps {
  brand: BrandData;
  open: boolean;
  onUpdated?: () => any;
  onCancle?: () => any;
...
const FMBrandUpdatePhoto: React.FC<FMBrandUpdatePhotoProps> = ({
  brand: catalog,
  open,
  onUpdated,
  onCancle,
...
export default FMBrandUpdatePhoto;
