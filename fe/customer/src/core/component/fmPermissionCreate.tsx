...
interface FMPermissionCreateProps {
  open: boolean;
  onCreated?: (data: PermissionData) => any;
  onCancle?: () => any;
}

const FMPermissionCreate: React.FC<FMPermissionCreateProps> = ({
  open,
  onCreated,
  onCancle,
}) => {
  ...
  const { mutate: checkName, isPending: checking } = useCheckPermissionName(
    (isExists) => {
...
export default FMPermissionCreate;
